...
import { FaUserPlus, FaBriefcase, FaUsers, FaChartLine, FaBuilding, FaClipboardList, FaArrowRight } from 'react-icons/fa';
                                        ...
                                        {recentJobs.map((job) => (
                                            <div key={job._id} className="p-6 hover:bg-slate-50/50 transition-colors flex justify-between items-center group">
                                                ...
                                                <div className="text-right">
                                                    <div className="text-sm font-bold text-slate-700">${job.salary?.toLocaleString()}</div>
